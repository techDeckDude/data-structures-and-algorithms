...
/**
 * This hash table implementation is the following:
 * 1) uses the java Object.hashCode() function to get a hash value
 *    which is then modded over the array size to find its appropriate index
 * 2) closed addressing (chaining) is used to handle collisions
 * 
 * 
 * 
 */
